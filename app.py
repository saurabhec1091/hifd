...
# loading in the model to predict on the data 
    ...
    scaling = joblib.load('https://github.com/saurabhec1091/hifd/blob/main/Scaler/scale.pkl')
    classifier = joblib.load('https://github.com/saurabhec1091/hifd/blob/main/PKL%20file/inpatient.pkl')
    ...
    X = pd.read_csv('https://media.githubusercontent.com/media/saurabhec1091/hifd/main/Data/inpatient.csv?token=ALWU2RQCR4UO67QYYU7AGCK7WWTKI')    
...
def provider():
    ...
    for i in range(1,no+1):
        ...
        X = pd.read_csv('https://media.githubusercontent.com/media/saurabhec1091/hifd/main/Data/provider.csv?token=ALWU2RUX4DWXFS7JQBOHNUS7WWTOQ')    
    ...
    if st.checkbox('Submit'):
        try:
            ...
            scaler = joblib.load('https://github.com/saurabhec1091/hifd/blob/main/Scaler/scaler_m.pkl')
            X = pd.DataFrame(scaler.transform(X),columns=X.columns)
            
            import xgboost
            classifier = joblib.load('https://github.com/saurabhec1091/hifd/blob/main/PKL%20file/xgb_model.pkl')
...
def csv():
    ...
    if st.checkbox("Submit"):          
        ...
        loaded_model = joblib.load('https://github.com/saurabhec1091/hifd/blob/main/PKL%20file/xgb_model.pkl')
...
def analysis():
    Train = pd.read_csv('https://media.githubusercontent.com/media/saurabhec1091/hifd/main/Data/train_data.csv?token=ALWU2RX3XIS5JPIEYXMRID27WWTQQ')
    Train_Beneficiarydata = pd.read_csv('https://media.githubusercontent.com/media/saurabhec1091/hifd/main/Data/Train_Beneficiarydata.csv?token=ALWU2RT3HD572E62NSACPHS7WWTBO')
    Train_Inpatientdata= pd.read_csv('https://media.githubusercontent.com/media/saurabhec1091/hifd/main/Data/Train_Inpatientdata.csv?token=ALWU2RQIZZEHS6SGVAI5HTK7WWS4Y')
    Train_Outpatientdata = pd.read_csv('https://media.githubusercontent.com/media/saurabhec1091/hifd/main/Data/Train_Outpatientdata.csv?token=ALWU2RW47DUT6YXB6LZ7ZDK7WWTFE')
    Train_ProviderWithPatientDetailsdata= pd.read_csv('https://media.githubusercontent.com/media/saurabhec1091/hifd/main/Data/Train_ProviderWithPatientDetailsdata.csv?token=ALWU2RUEH57VL7IS4DVBKI27WWTLG')
